...
isImageFile = (url) =>
{
	...
	return ext.includes( (extractExtensionFromDataUrl(url)) ?? extractFileExtension(url) );
}
// set Patient Dept
...
// emit an event when all things has been setup
// dispatch an event
var event = new CustomEvent('user-interface-setup-has-finished', { 
	detail: { 
